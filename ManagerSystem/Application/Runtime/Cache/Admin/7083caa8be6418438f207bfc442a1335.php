 ...
 <form action="" method="post">   
    <table class="tablelist">
      ...
      <tr>
        ...
        <?php if(is_array($roleinfo)): $i = 0; $__LIST__ = $roleinfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i; if($mod == 1): ?><tr style="background-color:lightblue;">
...
<!--             <td><?php echo ($v["a_pid"]); ?></td>
            <td><?php echo ($v["a_c"]); ?></td>
            <td><?php echo ($v["a_a"]); ?></td> -->


            <td>
                <a href="<?php echo U('distribute',array('r_id'=>$v['r_id']));?>" class="tablelink">分配权限</a> 

                <a href="<?php echo U('delete',array('r_id'=>$v['r_id']));?>" class="tablelink" onclick="if(!confirm('是否删除')){return false;}">删除</a>
            </td>
