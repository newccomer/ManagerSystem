 ...
 <form action="" method="post">   
    <table class="tablelist">
      ...
      <tr>
        ...
        <?php if(is_array($userinfo)): $i = 0; $__LIST__ = $userinfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i; if($mod == 1): ?><tr style="background-color:lightblue;">
        ...
        <?php else: ?>
            ...
            <td><a href="<?php echo U('update',array('u_id'=>$v['u_id']));?>" class="tablelink">修改用户信息</a> <a href="<?php echo U('change',array('u_id'=>$v['u_id']));?>" class="tablelink">分配用户</a>     <a href="<?php echo U('delete',array('u_id'=>$v['u_id']));?>" class="tablelink" onclick="if(!confirm('是否删除')){return false;}">删除</a></td>
